...
The bot also store the message contenta of the trading channel in the [growtopia builders](https://discord.gg/6tdegWUQXB) server under the server owners approval to only 
check items prices, the users or senders identity is not shared by anyone publicly and is not permantly stored in any of our databases, and
the prices keep getting updated automatically by time and the old prices gets deleted.
